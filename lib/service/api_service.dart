    ...
    if (checkUpdateTime(stringToTime(UserUpdateData.getLastUpdateData()))) {
      try {
        ...
        if (response.statusCode == 200) {
          ...
          String forecastDate = formatDateForFireStore(dailyForecast.date);
          FirestoreService().setDailyForecast(forecastDate, dailyForecast);
        ...
        return FirestoreService()
            .getDailyForecast(formatDateForFireStore(UserUpdateData.getDate()));
      } catch (e) {
        log(e.toString());
      }
    }
